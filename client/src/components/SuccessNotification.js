...
export function SuccessNotification() {
  ...
  if(itemInCart){
    ...
    return (
      <>
      <article className="message is-success" style={{width:'fit-content', position:"absolute"}}>
      <span className='message-body'>{itemInCart}</span>
      <button className='button is-success is-small' onClick={cartClose}>Close</button>
      </article>
    </>
    )
  } 
